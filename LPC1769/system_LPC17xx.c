    ...
    if (((LPC_SC->PLL0STAT >> 24) & 3) == 3) { /* If PLL0 enabled and connected */
        switch (LPC_SC->CLKSRCSEL & 0x03) {
            ...
            case 3: /* Reserved, default to Int. RC  */
                SystemCoreClock
                    = (IRC_OSC * (2ULL * ((LPC_SC->PLL0STAT & 0x7FFF) + 1)) / (((LPC_SC->PLL0STAT >> 16) & 0xFF) + 1)
                       / ((LPC_SC->CCLKCFG & 0xFF) + 1));
                break;
            case 1: /* Main oscillator => PLL0       */
                SystemCoreClock
                    = (OSC_CLK * (2ULL * ((LPC_SC->PLL0STAT & 0x7FFF) + 1)) / (((LPC_SC->PLL0STAT >> 16) & 0xFF) + 1)
                       / ((LPC_SC->CCLKCFG & 0xFF) + 1));
                break;
            case 2: /* RTC oscillator => PLL0        */
                SystemCoreClock
                    = (RTC_CLK * (2ULL * ((LPC_SC->PLL0STAT & 0x7FFF) + 1)) / (((LPC_SC->PLL0STAT >> 16) & 0xFF) + 1)
                       / ((LPC_SC->CCLKCFG & 0xFF) + 1));
                break;
        }
    } else {
